...
$admin_sql = "SELECT * FROM users WHERE user_id = '$user_id' AND role = 'admin' LIMIT 1";
...
function sendNotification($sender_id, $message, $conn) {
    ...
    if ($sender_data) {
        ...
        $receiver_role = ($sender_role === 'admin') ? 'manager' : 'admin';
...
<head>
    ...
    <title><?php echo $is_admin ? 'Admin Dashboard' : 'Profile - Maintenance Portal'; ?></title>
    <style>
    /* General Styles */
    body {
...
<header>
    <h1><?php echo $is_admin ? 'Admin Dashboard' : 'User Profile'; ?></h1>
</header>
...
<div class="container">
    ...
    <?php if ($is_admin): ?>
        <div>
            <h3>Admin Details</h3>
            <p><strong>Admin Name:</strong> <?php echo $admin_details['name']; ?></p>
            <p><strong>User ID:</strong> <?php echo $admin_details['user_id']; ?></p>
            <p><strong>Email:</strong> <?php echo $admin_details['email']; ?></p>
            <p><strong>Role:</strong> <?php echo $admin_details['role']; ?></p>
        </div>
    <?php endif; ?>
